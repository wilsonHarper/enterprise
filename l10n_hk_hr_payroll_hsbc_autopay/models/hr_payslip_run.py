...
class HrPayslipRun(models.Model):
    ...
    l10n_hk_autopay_export_first_batch_filename = fields.Char(string="Autopay File Name", help="Exported HSBC Autopay .apc file name")
    ...
    l10n_hk_autopay_export_second_batch_filename = fields.Char(string="Autopay File Name - Second Batch", help="Exported HSBC Autopay .apc file name")
